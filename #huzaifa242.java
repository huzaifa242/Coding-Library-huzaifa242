...
public class class_name{
	...
	private int INT_MAX=Integer.MAX_VALUE,INT_MIN=Integer.MIN_VALUE;
	...
	class Writer{
		...
		void print(Object o) throws Exception{pr.print(o);}
		void println(Object o) throws Exception{pr.println(o);}
		void flush() throws Exception{pr.flush();}
		void close() throws Exception{pr.close();}
		void printflush(Object o) throws Exception{println(o);flush();}
	}
	class pair<T,G>
	{
		T x; G y;
